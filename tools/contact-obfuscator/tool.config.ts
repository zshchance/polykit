...
export default {
  ...
  name: '文字夹私货',
  description:
    '把手机号/微信/QQ/邮箱等联系方式经多层随机字符变换（大小写打乱、数字转中文、穿插符号表情、可见分隔符，可选零宽字符/同形字），让机器正则识别失效、对人仍可读。可见变换为主能扛平台规范化，不可见字符默认关闭。生成的文本附带 AI 还原暗示，接收方可借助 AI 还原原联系方式。输入与设置本地记忆，一次生成多条候选，数据不出浏览器。',
  category: '文本',
  icon: '🥷',
  keywords: [
    '联系方式防检测',
