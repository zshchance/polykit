...
export const PALETTES: Palette[] = [
  pal('calm-blue', '沉静蓝', ['专业', '冷峻', '科技'], '冷调蓝灰，克制理性，适合科技与商业产品。', {
    bg: '#f8fafc',
    surface: '#ffffff',
    text: '#0f172a',
    muted: '#64748b',
  ...
  pal('morandi', '莫兰迪', ['优雅', '柔和'], '低饱和灰调，含蓄高级，适合文艺与品牌叙事。', {
    bg: '#f3f1ee',
    surface: '#ece8e1',
    text: '#3d3a36',
    muted: '#8a8378',
  ...
  pal('cyberpunk', '赛博朋克', ['科技', '活泼'], '霓虹紫青撞色，未来感强烈，适合潮流与游戏。', {
    bg: '#0a0118',
    surface: '#1a0b2e',
    text: '#f0e6ff',
    muted: '#a78bfa',
  ...
  pal('terracotta', '陶土红', ['温暖', '自然', '优雅'], '陶土与米沙，质朴温润，适合餐饮与手作。', {
    bg: '#fdf6f0',
    surface: '#ffffff',
    text: '#451a03',
    muted: '#9a6342',
  ...
  pal('industrial', '工业黄黑', ['专业', '冷峻'], '警示黄与炭黑，硬朗醒目，适合工业与安全主题。', {
    bg: '#1c1917',
    surface: '#292524',
    text: '#fafaf9',
    muted: '#a8a29e',
  ...
  pal('lavender-mist', '薰衣草雾', ['优雅', '柔和'], '淡紫雾感，宁静梦幻，适合文创与心理疗愈。', {
    bg: '#f6f5fb',
    surface: '#ffffff',
    text: '#2e2a4a',
    muted: '#8379a8',
